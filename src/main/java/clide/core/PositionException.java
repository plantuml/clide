...
/**
 * Why a &lt;file path&gt;:&lt;line&gt;:&lt;name&gt; token could not be resolved -
 * an IllegalArgumentException, as Position.parse() has always thrown, now
 * carrying the ErrorCode that says which of the four ways it failed.
 *
